...
var signalCenter, tbsettings, utility, workerScript, uploader, imageUploader, openDatabaseSync;
var __name, __bduss, __portrait;
var tbs;

function initialize(sc, ts, ut, ws, ul, iu, sql){
    DBHelper.initialize(sql);
